...
data %>%
  count(id, screen_name, sort = TRUE) -> z2
```
...
the content of the `r string_id_filt_main_long` (`r string_id_filt_main`) and
...
The computations used for identfying strongest sentiment differences
